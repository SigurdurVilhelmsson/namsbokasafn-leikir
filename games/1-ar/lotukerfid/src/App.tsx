...
import { CATEGORY_HEX, CATEGORY_NAMES_IS, type ElementCategory } from './data/elements';
...
const STORAGE_KEY = 'lotukerfid-progress';
...
const ELEMENT_CATEGORIES: { key: ElementCategory; emoji: string }[] = [
  { key: 'metal', emoji: '🔵' },
  { key: 'nonmetal', emoji: '🟢' },
  { key: 'metalloid', emoji: '🟡' },
];
      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 p-4 md:p-8">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-emerald-700 mb-2">{t('completion.title')}</h1>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h1 className="text-3xl font-bold text-emerald-700">{t('game.title')}</h1>
          ...
          {/* How it works */}
          <details className="bg-emerald-50 rounded-xl p-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          <h2 className="text-lg font-bold text-gray-700 mb-4">{t('menu.categories')}</h2>
          <div className="grid grid-cols-3 gap-3">
            {ELEMENT_CATEGORIES.map(({ key, emoji }) => (
              <div
                key={key}
                className="p-3 rounded-xl text-center"
                style={{ backgroundColor: `${CATEGORY_HEX[key]}15` }}
              >
                <span className="text-2xl">{emoji}</span>
                <div className="font-semibold text-sm mt-1" style={{ color: CATEGORY_HEX[key] }}>
                  {CATEGORY_NAMES_IS[key]}
                </div>
              </div>
            ))}
          </div>
