...
export const gameTranslations = createGameTranslations({
  is: {
    game: {
      ...
      description: 'Lærðu um Gibbs fríorkuna og spáðu hvort hvörf séu sjálfgeng',
    },
    intro: {
      title: 'Hvað er Gibbs fríorka?',
      description: 'Gibbs fríorka (ΔG) segir okkur hvort hvarf sé sjálfgengt. Ef ΔG < 0, þá gerist hvarfið sjálfkrafa.',
      formula: 'ΔG = ΔH - TΔS',
    },
    levels: {
      level1: {
    ...
    concepts: {
      enthalpy: 'Vermi (ΔH)',
      entropy: 'Óreiða (ΔS)',
      gibbsEnergy: 'Gibbs fríorka (ΔG)',
      spontaneous: 'Sjálfgengt',
      nonSpontaneous: 'Ekki sjálfgengt',
      exothermic: 'Útvermið (ΔH < 0)',
      endothermic: 'Innvermið (ΔH > 0)',
