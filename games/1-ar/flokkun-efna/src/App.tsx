          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="bg-teal-50 p-4 rounded-xl flex justify-between items-center">
                <div>
                  <div className="font-bold text-teal-800">{t('levels.level4.name')}</div>
                  <div className="text-sm text-teal-600">{t('levels.level4.description')}</div>
                </div>
                <div className="text-2xl font-bold text-teal-600">{progress.level4Score || 0}</div>
              </div>
        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <span className={`text-xl font-bold ${isLevel4Unlocked ? 'text-teal-800' : 'text-gray-500'}`}>
                ...
                <div className={`text-sm mt-1 ${isLevel4Unlocked ? 'text-teal-600' : 'text-gray-500'}`}>
