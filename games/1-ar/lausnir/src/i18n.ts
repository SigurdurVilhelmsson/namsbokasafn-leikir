...
export const gameTranslations = createGameTranslations({
  is: {
    ...
    levels: {
      ...
      level4: {
        name: 'Stig 4: Mettunarafl',
        description: 'Saturation & Crystallization',
        details: 'Sjáðu hvað gerist þegar lausn verður mettut - kristallar myndast!',
        locked: 'Ljúktu Stig 3 til að opna þetta stig.',
      },
      level5: {
        name: 'Stig 5: Rafleiðaraflokkun',
        description: 'Electrolyte Classification',
        details: 'Flokkaðu efni í sterka rafleiðara, veika rafleiðara og ekki rafleiðara.',
        locked: 'Ljúktu Stig 4 til að opna þetta stig.',
      },
      level6: {
        name: 'Stig 6: Stökefnafræði lausna',
        description: 'Solution Stoichiometry',
        details: 'Reiknaðu massa og rúmmál í efnahvörfum með lausnum.',
    ...
    completion: {
      ...
      level4Summary: 'Skilja mettun og kristallmyndun',
      level5Summary: 'Flokka efni eftir rafleiðni',
      level6Summary: 'Nota stökefnafræði til að reikna hvörf',
      saturation: 'Mettunarafl',
      electrolytes: 'Rafleiðaraflokkun',
      stoichiometry: 'Stökefnafræði',
  ...
  en: {
    ...
    levels: {
      ...
      level4: {
        ...
        description: 'Saturation & Crystallization',
        details: 'See what happens when a solution becomes saturated - crystals form!',
        locked: 'Complete Level 3 to unlock this level.',
      },
      level5: {
        name: 'Level 5: Electrolyte Classification',
        description: 'Electrolyte Classification',
        details: 'Classify substances as strong electrolytes, weak electrolytes, or non-electrolytes.',
        locked: 'Complete Level 4 to unlock this level.',
      },
      level6: {
        name: 'Level 6: Solution Stoichiometry',
        description: 'Solution Stoichiometry',
        details: 'Calculate mass and volume in reactions involving solutions.',
    ...
    completion: {
      ...
      level4Summary: 'Understand saturation and crystallization',
      level5Summary: 'Classify substances by conductivity',
      level6Summary: 'Use stoichiometry for reaction calculations',
      saturation: 'Saturation',
      electrolytes: 'Electrolyte Classification',
  ...
  pl: {
    ...
    levels: {
      ...
      level4: {
        name: 'Poziom 4: Nasycenie',
        description: 'Nasycenie i krystalizacja',
        details: 'Zobacz co sie dzieje gdy roztwor staje sie nasycony - krystaly sie tworzą!',
        locked: 'Ukonzcz Poziom 3, aby odblokowac ten poziom.',
      },
      level5: {
        name: 'Poziom 5: Klasyfikacja elektrolitow',
        description: 'Klasyfikacja elektrolitow',
        details: 'Klasyfikuj substancje jako mocne elektrolity, slabe elektrolity lub nieelektrolity.',
        locked: 'Ukonzcz Poziom 4, aby odblokowac ten poziom.',
      },
      level6: {
        name: 'Poziom 6: Stechiometria roztworow',
        description: 'Stechiometria roztworow',
        details: 'Oblicz mase i objetosc w reakcjach z udzialem roztworow.',
        locked: 'Ukonzcz Poziom 5, aby odblokowac ten poziom.',
      },
      completed: 'Ukonczone',
      points: 'punkty',
    },
    completion: {
      ...
      level4Summary: 'Rozumienie nasycenia i krystalizacji',
      level5Summary: 'Klasyfikuj substancje wedlug przewodnictwa',
      level6Summary: 'Uzyj stechiometrii do obliczen reakcji',
      saturation: 'Nasycenie',
      electrolytes: 'Klasyfikacja elektrolitow',
