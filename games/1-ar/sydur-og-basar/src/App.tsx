...
import { SUBSTANCE_TYPES } from './data/substances';
...
const STORAGE_KEY = 'sydur-og-basar-progress';
...
function App() {
  ...
  const handleLevel1Complete = (score: number, _maxScore: number) => {
    ...
    trackLevelComplete(1, score, 1500, {});
    setActiveLevel('menu');
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-blue-100 p-4 md:p-8">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-red-700 mb-2">{t('completion.title')}</h1>
            ...
            <div className="space-y-3 mb-6">
              <div className="bg-red-50 p-4 rounded-xl flex justify-between items-center">
                <div>
                  <div className="font-bold text-red-800">{t('levels.level1.name')}</div>
                  <div className="text-sm text-red-600">{t('levels.level1.description')}</div>
                </div>
                <div className="text-2xl font-bold text-red-600">{progress.level1Score || 0}</div>
              </div>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h1 className="text-3xl font-bold text-red-700">{t('game.title')}</h1>
        ...
        {/* Acid-Base Overview */}
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          <h2 className="text-lg font-bold text-gray-700 mb-4">S&yacute;rur og basar:</h2>
          <div className="grid grid-cols-2 gap-3">
            {(['acid', 'base'] as const).map(type => (
              <div
                key={type}
                className="p-3 rounded-xl text-center"
                style={{ backgroundColor: `${SUBSTANCE_TYPES[type].color}15` }}
              >
                <span className="text-2xl">{SUBSTANCE_TYPES[type].emoji}</span>
                <div className="font-semibold text-sm mt-1" style={{ color: SUBSTANCE_TYPES[type].color }}>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full p-6 rounded-xl border-4 border-red-400 bg-red-50 hover:bg-red-100 transition-all text-left"
          >
            <div className="flex items-center gap-4">
              <div className="text-4xl">{SUBSTANCE_TYPES.acid.emoji}</div>
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <span className="text-xl font-bold text-red-800">{t('levels.level1.name')}</span>
                ...
                <div className="text-sm mt-1 text-red-600">{t('levels.level1.description')}</div>
          ...
          >
            <div className="flex items-center gap-4">
              <div className="text-4xl">{isLevel2Unlocked ? '\u2696\uFE0F' : '\uD83D\uDD12'}</div>
              <div className="flex-1">
                <div className="flex items-center gap-2">
